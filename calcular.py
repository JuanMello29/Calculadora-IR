def calculadora_ir(salario_bruto):
    ...
    tabela_ir = [
        {"faixa": (0, 1903.98), "aliquotas": 0, "deducao": 0},
        {"faixa": (1903.99, 2826.65), "aliquotas": 7.5, "deducao": 142.80},
        {"faixa": (2826.66, 3751.05), "aliquotas": 15, "deducao": 354.80},
        {"faixa": (3751.06, 4664.68), "aliquotas": 22.5, "deducao": 636.13},
        {"faixa": (4664.69, float("inf")), "aliquotas": 27.5, "deducao": 869.36},
    ]
    ...
    for faixa in tabela_ir:
      if salario_bruto > faixa["faixa"][0] and salario_bruto <= faixa["faixa"][1]:
          imposto = (salario_bruto * faixa["aliquotas"]) / 100 - faixa["deducao"]
          break
    return imposto
